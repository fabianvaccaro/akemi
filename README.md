...
Graph-based codebase documentation for AI coding agents: the structure of your project is kept as plain YAML nodes and relations inside the repo, with no database and no server.
